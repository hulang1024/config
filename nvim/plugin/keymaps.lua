...
xmap_leader(";", cmd(".lua"), "Eval selection")
...
xmap_leader("x", cmd(".lua"), "Execute selection")
...
nmap_leader("du", function() require("dap"); require("dapui").toggle({ layout = 2 }) end, "Toggle DAP panels (DAP)")
nmap_leader("dC", function() require("dap"); require("dapui").toggle({ layout = 1 }) end, "Toggle DAP console (DAP)")
